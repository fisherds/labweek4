...
public class SetupModuleActivity extends Activity {
  ...
  private static String KEY_NUM_AVAILABLE_MODULES = "NUM_AVAILABLE_MODULES";
  ...
  protected void onRestoreInstanceState(Bundle savedInstanceState) {
    ...
    numberOfAvailableModules = savedInstanceState.getInt(KEY_NUM_AVAILABLE_MODULES);
    startTime.setText(savedInstanceState.getString(KEY_START_TIME));
    endTime.setText(savedInstanceState.getString(KEY_END_TIME));
  }


  @Override
  protected void onSaveInstanceState(Bundle outState) {
    outState.putInt(KEY_NUM_AVAILABLE_MODULES, numberOfAvailableModules);
    outState.putString(KEY_START_TIME, startTime.getText().toString());
    outState.putString(KEY_END_TIME, endTime.getText().toString());
